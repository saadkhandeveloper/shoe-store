...
<div className="p-5 my-5 bg-black/[0.05] rounded-xl">
  <div className='flex justify-between' >
    ...
    <div className='text-md md:text-lg font-medium text-black'>$36.00</div>
  </div>

<div className="text-sm md:text-md py-5 border-t mt-5">
  The subtotal reflects the total price of your order, 
  including duties and taxes, before any applicable discounts. It does not include delivery costs and international transaction fees.
</div>
</div>
{/* BUTTON START */}
...
{/* <div className='flex-[2] flex flex-col items-center pb-[50px] md:-mt-14 '>
  ...
  <span className="text-center mt-4">
    ...
    <br />
    Go ahead and explpore top categories.
  </span>
